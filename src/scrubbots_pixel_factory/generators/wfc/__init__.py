...
from .model import Exemplar, ExemplarRegistry, Pattern, PatternTable, WFCAttemptRecord, WFCConfig, WFCCandidate, WFCContractError
...
__all__ = [
    ...
    "WFCContractError", "WFCAttemptRecord", "WFCGenerator", "extract_pattern_table", "transformed_patterns",
