...
def test_python_and_gdscript_implementation_is_not_duplicated() -> None:
    ...
    assert all(
        ...
        in {
            ...
            "factory_studio_library.gd",
            "factory_studio_import_validation.gd",
            "factory_studio_pipeline.gd",
            "factory_studio_candidates.gd",
            "factory_studio_comparison.gd",
            "factory_studio_presets.gd",
            "factory_studio_search.gd",
            "factory_studio_readiness.gd",
            "factory_studio_reproduce.gd",
            "factory_studio_revisions.gd",
            "factory_studio_failures.gd",
            "factory_studio_batch_import.gd",
