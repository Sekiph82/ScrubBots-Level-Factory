...
func _run_suite() -> void:
	...
	_fixture_root = OS.get_temp_dir().path_join("scrubbots_lfx_014_batch_fixture"); _remove_tree(_fixture_root); DirAccess.make_dir_recursive_absolute(_fixture_root)
	var first := _fixture_root.path_join("first.png"); var second := _fixture_root.path_join("nested-second.png"); var corrupt := _fixture_root.path_join("bad.png")
