...
- Canonical LF/CP source-requirement classification: 26 VERIFIED, 53 PARTIAL, 9 MIGRATION, 108 NEW/OPEN, 28 GAME_RUNTIME.
- Canonical LF/CP source-requirement completion: **26 / 224 = 11.61%**.
...
- Unified verified completion: **26 / 227 = 11.45%**.
- Direct local implementation surface excluding 28 GAME_RUNTIME rows: **199 live tasks**.
- Conservative verified local completion: **26 / 199 = 13.07%**.
