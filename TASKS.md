...
- Current Sprint: SB-LF07.C001-R04 — M07 selective fourth strict remediation batch
- Current Task: SB-LF07-004 — Re-solve/revalidate every mutation
- Current Task Status: CHANGES_REQUIRED / R04_AUTHORIZED / SELECTIVE_REMEDIATE_THEN_REAUDIT
- Next Task/Action: Codex executes only `SB-LF07-004,005,006,007,008,009,010-C001-R04` from `.hiveai/prompts/SB-LF07-C001-R04_MASTER_REMEDIATION_PROMPT.md`; `SB-LF07-001`, `002`, and `003` are frozen PASS/CLOSED and must not be reimplemented. Codex creates seven task logs plus one master log, never edits `TASKS.md` or ChatGPT audits, then stops for independent re-audit.
- Required Actor: CODEX
- Tracking Repository: Sekiph82/ScrubBots-Level-Factory
- Tracking Branch: main
- Previous Strict Audit: `.hiveai/audits/SB-LF07-C001-R03_STRICT_REAUDIT_SUMMARY.md`
...
- Current Audit Criteria: original `SB-LF07-001..010-C001` strict criteria plus the R03 re-audits summarized by `.hiveai/audits/SB-LF07-C001-R03_STRICT_REAUDIT_SUMMARY.md`; `SB-LF07-001`, `002`, and `003` are accepted PASS/CLOSED.
- Current Prompt: `.hiveai/prompts/SB-LF07-C001-R04_MASTER_REMEDIATION_PROMPT.md`.
...
- SB-LFX Post-Batch Audit Result: `SB-LFX-003 = PASS/CLOSED`; `SB-LFX-004..017 = CHANGES_REQUIRED`.
- SB-LFX R01 Remediation Authorization: `SB-LFX-004..017-C001-R01 — REMEDIATE_ALL_THEN_REAUDIT`.
...
- SB-LFX R02 Re-Audit Result: `PASS/CLOSED = 005, 008, 009, 014, 017`; `CHANGES_REQUIRED = 011, 012, 013, 015, 016`.
- SB-LFX R02 Audit Summary: `.hiveai/audits/SB-LFX-005-017-C001-R02_STRICT_AUDIT_SUMMARY.md`.
- SB-LFX R03 Remediation Authorization: `SB-LFX-011,012,013,015,016-C001-R03 — REMEDIATE_ALL_THEN_REAUDIT`.
- SB-LFX R03 Remediation Index: `.hiveai/prompts/SB-LFX-011-016-C001-R03_REMEDIATION_INDEX.md`.
- SB-LFX R03 Master Prompt: `.hiveai/prompts/SB-LFX-011-016-C001-R03_MASTER_REMEDIATION_PROMPT.md`.
- SB-LFX R03 Tracker Policy: Codex does not advance task checkboxes; ChatGPT re-audits only the five R03 tasks after the full R03 batch.
- SB-LFX R03 Re-Audit Result: `PASS/CLOSED = 011, 012, 016`; `CHANGES_REQUIRED = 013, 015`.
- SB-LFX R03 Audit Summary: `.hiveai/audits/SB-LFX-011-016-C001-R03_STRICT_AUDIT_SUMMARY.md`.
- SB-LFX R04 Remediation Authorization: `SB-LFX-013,015-C001-R04 — REMEDIATE_ALL_THEN_REAUDIT`.
- SB-LFX R04 Remediation Index: `.hiveai/prompts/SB-LFX-013-015-C001-R04_REMEDIATION_INDEX.md`.
- SB-LFX R04 Master Prompt: `.hiveai/prompts/SB-LFX-013-015-C001-R04_MASTER_REMEDIATION_PROMPT.md`.
- SB-LFX R04 Tracker Policy: Codex does not advance task checkboxes; ChatGPT re-audits only the two R04 tasks after the full R04 batch.
- SB-LFX R04 Re-Audit Result: `PASS/CLOSED = 013, 015`; therefore `SB-LFX-001..017 = PASS/CLOSED`.
- SB-LFX R04 Audit Summary: `.hiveai/audits/SB-LFX-013-015-C001-R04_STRICT_AUDIT_SUMMARY.md`.
- SB-LF03-001 C001 Audit Criteria: `.hiveai/audit-criteria/SB-LF03-001-C001_HEADLESS_PUZZLE_SIMULATION_BOUNDARY_AUDIT_CRITERIA.md`.
- SB-LF03-001 C001 Prompt: `.hiveai/prompts/SB-LF03-001-C001_HEADLESS_PUZZLE_SIMULATION_BOUNDARY_PROMPT.md`.
...
- SB-LF03 Remaining Batch Authorization: `SB-LF03-003..012-C001 — IMPLEMENT_ALL_THEN_AUDIT`.
- SB-LF03 Remaining Batch Index: `.hiveai/prompts/SB-LF03-003-012-C001_IMPLEMENTATION_AND_AUDIT_INDEX.md`.
- SB-LF03 Remaining Batch Master Prompt: `.hiveai/prompts/SB-LF03-003-012-C001_MASTER_BATCH_IMPLEMENTATION_PROMPT.md`.
- SB-LF03 Post-Batch Strict Audit Protocol: `.hiveai/audit-criteria/SB-LF03-003-012-C001_POST_BATCH_STRICT_AUDIT_PROTOCOL.md`.
- SB-LF03 Batch Tracker Policy: task checkboxes remain ChatGPT-owned; Codex executes 003..012 sequentially without tracker edits; ChatGPT audits all ten only after the complete batch and creates a master remediation batch only for CHANGES_REQUIRED tasks.
- SB-LF03 C001 Post-Batch Audit Result: `PASS/CLOSED = 007`; `CHANGES_REQUIRED = 003, 004, 005, 006, 008, 009, 010, 011, 012`.
- SB-LF03 C001 Audit Summary: `.hiveai/audits/SB-LF03-003-012-C001_STRICT_AUDIT_SUMMARY.md`.
- SB-LF03 R01 Remediation Authorization: `SB-LF03-003,004,005,006,008,009,010,011,012-C001-R01 — REMEDIATE_ALL_THEN_REAUDIT`.
- SB-LF03 R01 Remediation Index: `.hiveai/prompts/SB-LF03-003-012-C001-R01_REMEDIATION_INDEX.md`.
- SB-LF03 R01 Master Prompt: `.hiveai/prompts/SB-LF03-003-012-C001-R01_MASTER_REMEDIATION_PROMPT.md`.
- SB-LF03 R01 Tracker Policy: Codex does not advance task checkboxes; ChatGPT re-audits all nine remediated tasks only after the complete R01 batch.
- SB-LF03 R01 Re-Audit Result: `PASS/CLOSED = 003, 004, 006, 008`; `CHANGES_REQUIRED = 005, 009, 010, 011, 012`; `007` remains previously PASS/CLOSED.
- SB-LF03 R01 Re-Audit Summary: `.hiveai/audits/SB-LF03-003-012-C001-R01_STRICT_REAUDIT_SUMMARY.md`.
- SB-LF03 R02 Remediation Authorization: `SB-LF03-005,009,010,011,012-C001-R02 — REMEDIATE_ALL_THEN_REAUDIT`.
- SB-LF03 R02 Remediation Index: `.hiveai/prompts/SB-LF03-005-012-C001-R02_REMEDIATION_INDEX.md`.
- SB-LF03 R02 Master Prompt: `.hiveai/prompts/SB-LF03-005-012-C001-R02_MASTER_REMEDIATION_PROMPT.md`.
- SB-LF03 R02 Tracker Policy: Codex does not advance task checkboxes; ChatGPT re-audits only the five R02 tasks after the full R02 batch.
- SB-LF03 R02 Re-Audit Result: `PASS/CLOSED = 005, 010`; `CHANGES_REQUIRED = 009, 011, 012`.
- SB-LF03 R02 Re-Audit Summary: `.hiveai/audits/SB-LF03-005-012-C001-R02_STRICT_REAUDIT_SUMMARY.md`.
- SB-LF03 R03 Remediation Authorization: `SB-LF03-009,011,012-C001-R03 — REMEDIATE_ALL_THEN_REAUDIT`.
...
- SB-LF04-001 C001-R01 Re-Audit Result: `PASS/CLOSED` by `.hiveai/audits/SB-LF04-001-C001-R01_WINDOWS_RUNNER_IDENTITY_PORTABILITY_AND_FULL_GATE_CLOSURE_STRICT_REAUDIT.md`.
- SB-LF04 Remaining Batch Authorization: `SB-LF04-002..012-C001 — IMPLEMENT_ALL_THEN_AUDIT`.
...
- SB-LF04 R01 Re-Audit Result: `PASS/CLOSED = 008, 009`; `CHANGES_REQUIRED = 004, 005, 006, 007, 010, 012`.
- SB-LF04 R01 Re-Audit Summary: `.hiveai/audits/SB-LF04-004-012-C001-R01_STRICT_REAUDIT_SUMMARY.md`.
- SB-LF04 R02 Remediation Authorization: `SB-LF04-004,005,006,007,010,012-C001-R02 — REMEDIATE_ALL_THEN_REAUDIT`.
- SB-LF04 R02 Remediation Index: `.hiveai/prompts/SB-LF04-004-012-C001-R02_REMEDIATION_INDEX.md`.
- SB-LF04 R02 Master Prompt: `.hiveai/prompts/SB-LF04-004-012-C001-R02_MASTER_REMEDIATION_PROMPT.md`.
- SB-LF04 R02 Re-Audit Result: `PASS/CLOSED = 004, 005, 006, 007, 010`; `CHANGES_REQUIRED = 012`.
- SB-LF04 R02 Re-Audit Summary: `.hiveai/audits/SB-LF04-004-012-C001-R02_STRICT_REAUDIT_SUMMARY.md`.
...
- SB-LF07 C001 Strict Audit Result: `CHANGES_REQUIRED = 001,002,003,004,005,006,007,008,009,010`; no M07 task is PASS/CLOSED from C001.
- SB-LF07 C001 Audit Summary: `.hiveai/audits/SB-LF07-001-010-C001_STRICT_AUDIT_SUMMARY.md`.
- SB-LF07 R01 Remediation Authorization: `SB-LF07-001..010-C001-R01 — REMEDIATE_ALL_THEN_REAUDIT`.
...
- SB-LF07 R03 Re-Audit Result: `PASS/CLOSED = 001,002,003`; `CHANGES_REQUIRED = 004,005,006,007,008,009,010`.
- SB-LF07 R03 Re-Audit Summary: `.hiveai/audits/SB-LF07-C001-R03_STRICT_REAUDIT_SUMMARY.md`.
- SB-LF07 R04 Remediation Authorization: `SB-LF07-004..010-C001-R04 — SELECTIVE_REMEDIATE_THEN_REAUDIT`.
- SB-LF07 R04 Remediation Index: `.hiveai/prompts/SB-LF07-C001-R04_REMEDIATION_INDEX.md`.
- SB-LF07 R04 Master Prompt: `.hiveai/prompts/SB-LF07-C001-R04_MASTER_REMEDIATION_PROMPT.md`.
- SB-LF07 R04 Tracker Policy: `001`, `002`, and `003` remain frozen PASS/CLOSED; Codex remediates only `004..010` and ChatGPT re-audits only those after the complete R04 batch.
...
- `SB-LF06-007` is PASS/CLOSED through `SB-LF06-007-C001-R01`; wrong-task LF06-005 mutations were restored byte-for-byte to the accepted baseline, and the approved puzzle-config edit gate now truthfully reports `UNAVAILABLE` with no mutation controls because no authoritative Studio-editable gameplay/puzzle-config contract currently exists.
- `SB-LF06-008` is PASS/CLOSED through `SB-LF06-008-C001-R01`; manual DIRTY artwork now receives real canonical Python structural/art QA with exact source-policy reuse, immutable source bytes and canonical grid-hash binding, and STALE results can repeatedly re-enter fresh revalidation without Reset while stale evidence remains non-current.
...
- [x] SB-LF03-003 — Define legal-move-provider interface.

### M03.02 - Deterministic search and solver evidence

- [x] SB-LF03-004 — Implement deterministic baseline search when semantics available.
- [x] SB-LF03-005 — Add visited-state memoization/hashing.
- [x] SB-LF03-006 — Record solution path/states/dead ends/depth/branching/solve time.
- [x] SB-LF03-007 — Add correctness-preserving pruning/order only with tests.
- [x] SB-LF03-008 — Add bounded solution-count/entropy analysis.
...
- [x] SB-LF04-004 — Add dependency depth only when canonical.
- [x] SB-LF04-005 — Add slot pressure only when canonical.
- [x] SB-LF04-006 — Add bait/deadlock metrics only when canonical.
- [x] SB-LF04-007 — Add color/remaining-state volatility where useful.

### M04.03 - Difficulty V1 challenge, provenance and calibration

- [x] SB-LF04-008 — Implement/version Difficulty V1 Challenge Score components/coefficients.
...
- [x] SB-LF06-007 — Approved puzzle-config edits only.

### M06.03 - Revalidation, truth separation, reproduction and tests

- [x] SB-LF06-008 — Revalidate after manual changes.
- [x] SB-LF06-009 — Never auto-promote generated candidate.
- [x] SB-LF06-010 — Keep editor presentation separate from truth.
- [x] SB-LF06-011 — Reproduce candidate by seed/config.
- [x] SB-LF06-012 — Editor smoke + headless core tests.
...
- [x] SB-LFX-005 — Build bounded one-click pipeline orchestration across applicable Import/Generate→Normalize→Validate→Candidate→Solve→Difficulty→QA→Review stages. [EXTENSION]
...
- [x] SB-LFX-008 — Add reusable Presets / Production Recipes while always persisting the fully expanded canonical request/config. [EXTENSION]

### M06.06 - Discovery, readiness, reproduction and edit lineage extensions

- [x] SB-LFX-009 — Add scalable search/filter/smart collections as derived views over canonical source/candidate/level records. [EXTENSION]
...
- [x] SB-LF07-001 — Mutation interface/immutable lineage.
...
- [x] SB-LFX-013 — Build Failure Inbox / Retry Center that retries only eligible failed/rejected/inconclusive work while preserving failure evidence and lineage. [EXTENSION]
- [x] SB-LFX-014 — Support drag-and-drop multi-file Pixel Art batch import with independent immutable provenance per file. [EXTENSION]
- [x] SB-LFX-015 — Add Factory Studio session recovery/autosave that resumes eligible durable jobs without redoing successful stages. [EXTENSION]
...
- [x] SB-LFX-016 — Add advisory visual-similarity guard for near-duplicate artwork/candidates while retaining exact identity checks and avoiding silent auto-reject policy. [EXTENSION]
- [x] SB-LFX-017 — Build Provider Cost / Credit Center for truthful jobs/success/failure/consumed/remaining/cost-per-accepted accounting where reliable provider data exists. [EXTENSION]
